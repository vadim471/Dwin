...
typedef enum {
   ...
   // CL2_DEV_PCSC_ACR128 = 0x0C,
    ...
    /**
     * \brief \c <b>0x27</b> Сервис работы с картами OPTI.
     */
    CL2_DEV_PAY_OPTI = 0x27,
    ...
    /**
     * \brief \c <b>0x34</b> Платежный терминал работающий по протоколу UniPOS.
     */
    CL2_DEV_UNIPOS_GENERIC = 0x34
