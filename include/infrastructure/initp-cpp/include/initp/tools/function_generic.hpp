#ifndef INITPLUS_TOOLS_FUNCTION_GENERIC_HPP_INCLUDED
#define INITPLUS_TOOLS_FUNCTION_GENERIC_HPP_INCLUDED
...
#endif // INITPLUS_TOOLS_FUNCTION_GENERIC_HPP_INCLUDED
