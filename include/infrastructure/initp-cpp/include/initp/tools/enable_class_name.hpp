#ifndef INITPLUS_TOOLS_ENABLE_CLASS_NAME_HPP_INCLUDED
#define INITPLUS_TOOLS_ENABLE_CLASS_NAME_HPP_INCLUDED
...
#endif // INITPLUS_TOOLS_ENABLE_CLASS_NAME_HPP_INCLUDED
