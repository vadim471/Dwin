#include <initp/tools/locale.hpp>
...
std::string local_to_utf8(const std::string& string) {
    ...
    try {
        ...
        sys_debug_print(SYSTEM_LEVEL_ERROR, "tools::locale::local_to_utf8", "Conversion failed. %s", e.what());
    }
    return std::string();
}
...
std::string utf8_to_local(const std::string& string) {
    ...
    try {
        ...
        sys_debug_print(SYSTEM_LEVEL_ERROR, "tools::locale::utf8_to_local", "Conversion failed. %s", e.what());
    }
    return std::string();
}
...
std::string cp1251_to_utf8(const std::string& string) {
    ...
    try {
        ...
        sys_debug_print(SYSTEM_LEVEL_ERROR, "tools::locale::cp1251_to_utf8", "Conversion failed. %s", e.what());
    }
    return std::string();
}
...
std::string utf8_to_cp1251(const std::string& string) {
    ...
    try {
        ...
        sys_debug_print(SYSTEM_LEVEL_ERROR, "tools::locale::utf8_to_cp1251", "Conversion failed. %s", e.what());
    }
    return std::string();
}
