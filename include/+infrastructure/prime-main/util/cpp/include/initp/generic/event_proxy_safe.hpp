#ifndef INITPLUS_GENERIC_EVENT_PROXY_SAFE_HPP_INCLUDED
#define INITPLUS_GENERIC_EVENT_PROXY_SAFE_HPP_INCLUDED
...
#endif // INITPLUS_GENERIC_EVENT_PROXY_SAFE_HPP_INCLUDED
