#ifndef INITPLUS_GENERIC_CAN_HPP_INCLUDED
#define INITPLUS_GENERIC_CAN_HPP_INCLUDED

#include <initp/generic/bind.hpp>
#include <initp/interface/cancellable.hpp>
...
#endif // INITPLUS_GENERIC_CAN_HPP_INCLUDED
