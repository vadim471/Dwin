...
#define SYSTEM_LEVEL_FATAL 0
#define SYSTEM_LEVEL_ERROR 1
#define SYSTEM_LEVEL_WARNING 2
#define SYSTEM_LEVEL_INFO 3
#define SYSTEM_LEVEL_DEBUG 4
#define SYSTEM_LEVEL_TRACE 5
