#ifndef INITPLUS_HTTP_LOGGER_HPP_INCLUDED
#define INITPLUS_HTTP_LOGGER_HPP_INCLUDED

#include "binary/connection.hpp"
    ...
    void trace(uint8_t level, const T& what, const Args&... args) {
        ...
        boost::asio::post(
            boost::asio::bind_executor(
                this->strand_,
                RBIND(push_message, level, target, message, system::time::milliseconds())
            )
        );
    }
...
private: // Private fields
    ...
    initp::http::binary::connection::ptr connection_;
...
#endif // INITPLUS_HTTP_LOGGER_HPP_INCLUDED
