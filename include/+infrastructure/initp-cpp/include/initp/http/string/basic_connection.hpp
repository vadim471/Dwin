#ifndef INITPLUS_HTTP_STRING_BASIC_CONNECTION_HPP_INCLUDED
#define INITPLUS_HTTP_STRING_BASIC_CONNECTION_HPP_INCLUDED

#include <initp/http/string/connection.hpp>
...
public: // Public methods
    ...
    virtual system::error_code get(const std::string&, const header_list_t&, on_response_f);
...
protected: // Private methods
    ...
    void on_write(boost::system::error_code, std::size_t bytes_transferred, on_response_f);
...
#endif // INITPLUS_HTTP_STRING_BASIC_CONNECTION_HPP_INCLUDED
