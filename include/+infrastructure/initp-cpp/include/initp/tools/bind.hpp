#ifndef INITPLUS_TOOLS_BIND_HPP_INCLUDED
#define INITPLUS_TOOLS_BIND_HPP_INCLUDED

#include "bindable.hpp"

#ifdef SHOW_BIND_CLASS_NAME
#include "enable_class_name.hpp"
...
public: // Construction
    bind(void):
        ...
        INFO_("shared::tools::bind<", class_name, ">(void);");
        #endif // SHOW_BIND_CLASS_NAME
    }
    bind(const T& v):
        bindable(),
        ...
        #ifdef SHOW_BIND_CLASS_NAME
        std::string class_name = this->class_name();
        INFO_("shared::tools::bind<", class_name, ">(const ", class_name, "&);");
        #endif // SHOW_BIND_CLASS_NAME
    }
    bind(const bind& c):
        bindable(c),
        ...
        #ifdef SHOW_BIND_CLASS_NAME
        std::string class_name = this->class_name();
        INFO_("shared::tools::bind<", class_name, ">(const bind&);");
        #endif // SHOW_BIND_CLASS_NAME
    }
    virtual ~bind(void) {
        #ifdef SHOW_BIND_CLASS_NAME
...
#endif // INITPLUS_TOOLS_BIND_HPP_INCLUDED
