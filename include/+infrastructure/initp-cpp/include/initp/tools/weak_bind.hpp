#ifndef INITPLUS_TOOLS_WEAK_BIND_HPP_INCLUDED
#define INITPLUS_TOOLS_WEAK_BIND_HPP_INCLUDED
...
protected:
    ...
    static R invoker(
        ...
        if (std::shared_ptr<T> lock = wptr.lock()) {
            ...
            INFO_("Object is gone for class ", name);
            #endif // SHOW_BIND_CLASS_NAME
        }
    }
};
...
#endif // INITPLUS_TOOLS_WEAK_BIND_HPP_INCLUDED
